  ...
  methods: {
    ...
    async save () {
      ...
      if (this.editedIndex > -1) {
        this.busy = true
        await this.$store.dispatch('updatePet', this.editedItem)
        this.busy = false
        this.$store.dispatch('responseMessage', {
          type: 'success',
          text: 'Successfully Edit Pet'
        })
      } else {
        var newItem = Object.assign({}, this.editedItem)
        Object.assign(newItem, { client_id: this.authUser.client.id })
        this.busy = true
